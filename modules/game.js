...
class GameManager {
    ...
    startLevel() {
        ...
        this.pizzasCollected = 0;
        this.placeObjects();
        this.renderer.setText("Colete as pizzas!", "vermelho");
    }
    ...
    placeObjects() {
        ...
        // possição aleatorias das pizzas
    ...
    update() {
        // update timer
        if(!this.isPaused) this.time -= 1/30; // framerate fixa
        ...
        // checa collecão de checkpoints das pizzas.
        if(this.pizzas.length > 0) {
            ...
            this.renderer.setText("Retorna para o inicio!", "amarelo")
